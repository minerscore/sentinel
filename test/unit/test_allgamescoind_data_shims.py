...
# TODO: remove fixtures below here once test_SHIM_serialise_for_ravendarkd removed
...
@pytest.fixture
def ravendarkd_superblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_ravendarkd(sentinel_proposal_hex, sentinel_superblock_hex):
    assert ravendarklib.SHIM_serialise_for_ravendarkd(sentinel_proposal_hex) == ''
    assert ravendarklib.SHIM_serialise_for_ravendarkd(sentinel_superblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.ravendarkcentral.org/black-pearl',
